                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="title" class="form-control form-control-user" aria-describedby="emailHelp"
                                                    placeholder="course title" id="title" name="title" :value="old('title')"  autofocus autocomplete="title" />
                                              ...
                                              <div class="form-group">
                                                ...
                                                <textarea  class=" form-control form-control-user" aria-describedby="emailHelp"
                                                    placeholder="course exerpts (max:100 words)" id="excerpts" name="excerpts" :value="old('excerpts')"  autofocus autocomplete="excerpts" ></textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea  class="ckeditor form-control form-control-user" aria-describedby="emailHelp"
                                                    placeholder="course content" id="fullText" name="fullText" :value="old('fullText')"  autofocus autocomplete="fullText" ></textarea>
                                        ...
                                        <div class="text-center">
                                         ...
                                         <div class="form-group ">
                                                ...
                                                <input type="file" class="form-control form-control-user" aria-describedby="emailHelp"
                                                    placeholder="course image" id="image" name="image" :value="old('image')"  autofocus autocomplete="image" />

                                                <x-input-error :messages="$errors->get('image')" style="color:red;font-size:11px" class="mt-2" />
                                            </div>
                                        <div class="form-group ">

                                            <select name="trainer" id="trainer" class="form-control " aria-describedby="emailHelp" style="border-radius:20px;height:50px;">
                                                <option value="{{null}}">~ Select the trainer ~</option>
                                            ...
                                            <x-input-error :messages="$errors->get('trainer')" style="color:red;font-size:11px" class="mt-2" />
                                        </div>
                                            <div class="form-group ">

                                                <input type="number" min="0" step="0.01" class="form-control form-control-user" aria-describedby="emailHelp"
                                                    placeholder="course cost" id="price" name="price" :value="old('price')"  autofocus autocomplete="price" />

                                                <x-input-error :messages="$errors->get('price')" style="color:red;font-size:11px" class="mt-2" />
                                            </div>

                                        <div class="form-group">
                                                <span class="pl-3" style="color:black;font-size:12px">Course Url</span>
                                                <input  class="form-control form-control-user"
                                                    placeholder="course url e.g https://youtube.com" id="courseDetail" name="courseDetail" value="{{old('courseDetail')}}"  autofocus autocomplete="courseDetail" />
